...
- [ ] Run `npm run check:experience` successfully for exact candidate `8b192c84b311d237617db830b65ad0fccac7ce9b` with only metadata changes afterward.
...
- [ ] Feature-freeze the exact passing commit SHA: `8b192c84b311d237617db830b65ad0fccac7ce9b`.
